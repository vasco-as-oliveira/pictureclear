        ...
        <div class="container-fluid container-register" id="container-register">
            <div class="form-container sign-up-container">
                ...
                <form method="POST" action="{{ url('/course/create') }}" class="form register">
                    ...
                    <input id="title" placeholder="Titulo" class="input @error('title') is-invalid @enderror"
                        type="text" name="title" value="{{ old('title') }}" required autocomplete="title" autofocus>
                    ...
                    <input id="description" placeholder="Descrição do curso"
                    ...
                    <select id="language" placeholder="Linguagem" class="select @error('language') is-invalid @enderror"
                        type="text" name="language" required autocomplete="language" autofocus>
                    ...
                    <div class="col-3">
                        <div class="container-fluid container-register" id="container-register">
                            <div class="form-container sign-up-container">
                                ...
                                <h5>Acesso a um horário de marcação - &#10003;</h5>
                                <input min="1" step="any" placeholder="Preço"
                                    class="input @error('price3') is-invalid @enderror" type="number" name="price3"
                                    value="{{ old('price3') == null ? 1 : old('price3') }}" required
                                    autocomplete="price3" autofocus>
