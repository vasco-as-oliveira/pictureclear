							...
							@foreach ($sentMessages as $message)
								...
								@endif
									<div>
										...
										<img src="{{ Auth::user()->picture != null ? URL::asset('storage/images/'.Auth::user()->picture) : URL::asset('images/default-profilepicture.png') }}" class="rounded-circle mr-1" alt="Chris Wood" width="40" height="40" style="object-fit: cover;">
										@else
										<img src="{{ $sender->picture != null ? URL::asset('storage/images/'.$sender->picture) : URL::asset('images/default-profilepicture.png') }}" class="rounded-circle mr-1" alt="Chris Wood" width="40" height="40" style="object-fit: cover;">
										@endif
									...
									<div class="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
										...
										@else
										<div class="font-weight-bold mb-1">{{$sender->firstname.' '.$sender->lastname}}</div>
										@endif
										{{$message->message}}
									</div>
								</div>
