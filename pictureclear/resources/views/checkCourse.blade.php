...
@section('content')
    ...
    @if ($checkCourse)
                                    ...
                                    <div class="overlay-container">
                                        <div class="overlay">
                                            ...
                                            <form method="get" action="{{ url('/comprarCurso') }}">
                                                <input type="text" name="course" value="{{ $checkCourse[0]->id }}"
                                                    style="display: none;">
                                                <input type="submit">
                                            </form>
                                            <div class="overlay-container">
        ...
        @endif
        <form method="GET" id="viewVideos" action="{{ url('/videos', ['id' => $checkCourse[0]->id]) }}"
            enctype="multipart/form-data">
            @csrf
            <button form="viewVideos" type="submit" id="viewClasses" class="label checkbox btn btn-success">Visualizar
                Aulas</button>
        </form>
        </div>
